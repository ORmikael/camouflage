...
function Footer() {
  ...
  <li><a href="https://twitter.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-x-twitter"></i></a></li> {/* Twitter Icon */}
  <li><a href="https://linkedin.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin-in"></i></a></li>
</ul>

      <p>&copy; 2025 CamoTrails Safaris. All rights reserved.</p>
    </footer>
  );
}
